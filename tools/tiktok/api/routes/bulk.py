...
from tools.tiktok.api.services import job_store, ytdlp_service, metadata_service
from tools.storage import tool_data_dir

router = APIRouter()

DOWNLOADS_DIR = tool_data_dir("tiktok") / "downloads"
...
async def download_selected(req: DownloadSelectedRequest, background_tasks: BackgroundTasks):
    ...
    from tools.tiktok.api.services.zip_service import build_zip
